module AuditLogModule
  ...
  class AuditLogParser
    ...
    def get_process_name_by_id(pid)
      begin
        return IO.read("/proc/#{pid}/cmdline").tr("\000", ' ').strip
      rescue
        # Process terminated
      end
    end
    ...
    def get_user_name_by_id(uid)
      return 'unset' if uid == 4294967295  # stand for 0xffffffff
    ...
    def get_group_name_by_id(gid)
      return 'unset' if gid == 4294967295  # stand for 0xffffffff
